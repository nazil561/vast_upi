import{_ as O,C as P,r as v,a as D,c as _,h as w,d as R,g as L,i as x,p as F,u as U,F as $}from"./firebase-auth-Jk6tzhS9.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(e=L(),t=k){const n=_(w(e),E).getImmediate({identifier:t}),i=R("functions");return i&&ie(n,...i),n}function ie(e,t,r){B(w(e),t,r)}function ae(e,t,r){return X(w(e),t)}re();export{oe as g,ae as h};
//# sourceMappingURL=firebase-functions-Cibth4Xy.js.map
